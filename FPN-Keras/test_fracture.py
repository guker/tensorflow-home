...
__CLASS__ = ['__background','person','bird','cat', 'cow', 'dog', 'horse', 'sheep','aeroplane', 'bicycle',
...
class VOCConfig(Config):
    ...
    NUM_CLASSES = 1 + 20  # background + n class
    ...
    VOCDATA_PATH = '/SkyDiscovery/cephfs/user/qunwei.hu/dataset/VOCdevkit/VOC2007'
...
def test_vision():
    ...
    if init_with == "imagenet":
        ...
        model.load_weights('./logs/fracture20181224T1729/mask_rcnn_fracture_0100.h5', by_name=True)
    elif init_with == "last":
